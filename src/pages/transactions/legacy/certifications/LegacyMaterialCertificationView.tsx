...
export const LegacyMaterialCertificationView = (props: CertificationViewerChildProps) => {

    return (
        <CardPage title="Material Certification">
                ...
                <Row gutter={[8, 8]}>
                    <Col span={12}>
                        <Form.Item label="Material" name="material">
                            <Input placeholder={props.certification.material?.name} />
                        </Form.Item>
                    </Col>
                </Row>
...
export default LegacyMaterialCertificationView;
