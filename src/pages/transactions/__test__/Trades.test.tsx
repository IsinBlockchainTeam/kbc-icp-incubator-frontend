...
//         const trade1: TradePreviewPresentable = new TradePreviewPresentable();
//         trade1.setSupplier('Supplier 1')
//             .setCustomer('Customer 1')
//             .setType(TradeType.BASIC);
//         const trade2: TradePreviewPresentable = new TradePreviewPresentable();
//         trade2.setSupplier('Supplier 2')
//             .setCustomer('Customer 2')
//             .setType(TradeType.ORDER);
//         const mockedTrades: TradePreviewPresentable[] = [trade1, trade2];
...
//         const trade1: TradePreviewPresentable = new TradePreviewPresentable(1);
//         trade1.setSupplier('Supplier 1')
//             .setCustomer('Customer 2')
//             .setType(TradeType.BASIC);
//         const trade2: TradePreviewPresentable = new TradePreviewPresentable(2);
//         trade2.setSupplier('Supplier 2')
//             .setCustomer('Customer 1')
//             .setType(TradeType.ORDER);
//         const mockedTrades: TradePreviewPresentable[] = [trade1, trade2];
...
//         const trade0: TradePreviewPresentable = new TradePreviewPresentable(0);
...
//         trade2.setSupplier('Supplier 2')
//             .setType(TradeType.ORDER);
//         const mockedTrades: TradePreviewPresentable[] = [trade0, trade1, trade2];
//         const mockedGetGeneralTrades = jest.fn().mockResolvedValueOnce(mockedTrades);
//         (EthTradeService as jest.Mock).mockImplementation(() => ({
//             getGeneralTrades: mockedGetGeneralTrades
//         }));
