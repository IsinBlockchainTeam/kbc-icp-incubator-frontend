...
describe('Asset Operations', () => {
    ...
    it('should render correctly', () => {
        ...
        expect(screen.getByRole('button', {name: 'plus New Asset Operation'})).toBeInTheDocument();
    });

    it('should fetch data', async () => {
        const mockedAssetOperations: AssetOperationPresentable[] = [new AssetOperationPresentable(1, 'Asset Operation 1', [], new MaterialPresentable(1, 'Material 1')), new AssetOperationPresentable(2, 'Asset Operation 2', [], new MaterialPresentable(2, 'Material 2'))];
        ...
        await waitFor(() => {
            expect(TransformationService).toHaveBeenCalledTimes(1);
    ...
    it('should render \'No output material\' when there is no output material', async () => {
        const mockedAssetOperations: AssetOperationPresentable[] = [new AssetOperationPresentable(1, 'Asset Operation 1', [], undefined)];
        const mockedGetTransformations = jest.fn().mockResolvedValueOnce(mockedAssetOperations);
        (TransformationService as jest.Mock).mockImplementation(() => ({
            getTransformations: mockedGetTransformations
        }));
    ...
    it('should call sorter function correctly when clicking on a table header', async () => {
        const mockedAssetOperations: AssetOperationPresentable[] = [new AssetOperationPresentable(1, '2. Asset Operation 1', [], new MaterialPresentable(1, 'Material 1')), new AssetOperationPresentable(2, '1. Asset Operation 2', [], new MaterialPresentable(2, 'Material 2'))];
        const mockedGetTransformations = jest.fn().mockResolvedValueOnce(mockedAssetOperations);
        (TransformationService as jest.Mock).mockImplementation(() => ({
            getTransformations: mockedGetTransformations
        }));
    ...
    it('should sort also when working with falsy names', async () => {
        const mockedAssetOperations: AssetOperationPresentable[] = [new AssetOperationPresentable(0, undefined, [], new MaterialPresentable(0, 'Zero material')), new AssetOperationPresentable(1, 'Valid', [], new MaterialPresentable(1, 'Material 1')), new AssetOperationPresentable(2, undefined, [], new MaterialPresentable(2, 'Material 2'))];
        const mockedGetTransformations = jest.fn().mockResolvedValueOnce(mockedAssetOperations);
        (TransformationService as jest.Mock).mockImplementation(() => ({
            getTransformations: mockedGetTransformations
        }));
