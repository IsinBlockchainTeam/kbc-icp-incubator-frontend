...
describe('CoffeeProduction', () => {
    ...
    it('should render fancy message if no document is approved', () => {
        ...
        render(<CoffeeProduction orderTrade={orderTrade} />);
        expect(TradeDutiesWaiting as jest.Mock).toHaveBeenCalledTimes(1);
    });

    it.each([['payment-invoice', 'Payment Invoice']])(
    ...
    it.each([['payment-invoice', DocumentType.PAYMENT_INVOICE]])(
