import {BlockchainAssetOperationStrategy} from "../BlockchainAssetOperationStrategy";
...
import {AssetOperation, Material, ProductCategory} from "@kbc-lib/coffee-trading-management-lib";
