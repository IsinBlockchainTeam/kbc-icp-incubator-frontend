...
export type CertificationContextState = {
    ...
    getCompanyCertificates: (subject: string) => Promise<ICPCompanyCertificate[]>;
    getScopeCertificatesByProcessType: (subject: string, processType: string) => Promise<ICPScopeCertificate[]>;
    getMaterialCertificatesByMaterialId: (subject: string, materialId: number) => Promise<ICPMaterialCertificate[]>;
    getDocument: (certificateId: number) => Promise<ICPCertificateDocument>;
};
...
export function CertificationProvider(props: { children: ReactNode }) {
    ...
    const getCompanyCertificates = async (subject: string): Promise<ICPCompanyCertificate[]> => {
        return certificationService.getCompanyCertificates(subject);
    };
    ...
    const getScopeCertificatesByProcessType = async (subject: string, processType: string): Promise<ICPScopeCertificate[]> => {
        return certificationService.getScopeCertificatesByProcessType(subject, processType);
    };
    ...
    const getMaterialCertificatesByMaterialId = async (subject: string, materialId: number): Promise<ICPMaterialCertificate[]> => {
        return certificationService.getMaterialCertificatesByMaterialId(subject, materialId);
    };
    ...
    const getDocument = async (certificateId: number): Promise<ICPCertificateDocument> => {
        return certificationService.getDocument(certificateId);
    };
    ...
    return (
        <CertificationContext.Provider
            value={{
                ...
                getScopeCertificatesByProcessType,
                getMaterialCertificatesByMaterialId,
                getDocument
            }}
            {...props}
        />
