...
export const getNameByDID = async (organizationDriver: ICPOrganizationDriver, did: string): Promise<string> => {
    let serviceUrl;
    try {
...
export function ICPProvider({ children }: { children: ReactNode }) {
    ...
    const icpOrganizationDriver = new ICPOrganizationDriver(identity, driverCanisterIds.organization);
